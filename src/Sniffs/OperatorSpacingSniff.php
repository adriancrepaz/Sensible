...
/**
 * Based off of the default Squiz rule.
 * Allows no-spaces around OR bitwise operators, for example in Exception catch statements.
 *
...
class OperatorSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($stackPtr - 1)]['code'] !== T_WHITESPACE
            ...
            if($tokens[$stackPtr]['type'] !== 'T_BITWISE_OR') {
